		...
		if (invitedByMe) {
			if (search != null && !search.isEmpty()) {
				users = userRepository
						.findByCorporateIdAndInvitedByIdAndEmailContainingIgnoreCaseOrCorporateIdAndInvitedByIdAndNameContainingIgnoreCase(
								corporateId, currentUser.getId(), search, corporateId, currentUser.getId(), search,
								pageable);
			} else {
			...
			if (search != null && !search.isEmpty()) {
				users = userRepository
						.findByCorporateIdAndEmailContainingIgnoreCaseOrCorporateIdAndNameContainingIgnoreCase(
