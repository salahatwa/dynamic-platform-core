-- Template Folder Management System - Database Schema (No Permissions)
-- PostgreSQL
...
-- 4. Function to update materialized path when folder hierarchy changes
...
-- 5. Function to recursively update paths of all child folders
...
-- 6. Migration Script: Create root folders for existing applications and move templates
DO $
DECLARE
    app_record RECORD;
...
-- 7. Validation queries to verify migration success
DO $
DECLARE
...
-- 8. Create helpful views for folder management
